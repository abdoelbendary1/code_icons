...
/* autApi */
  ...
  static String tradeOfficeEndPoint = "api/TradeOffice";
  ...
  static String vacationType = "/api/VactionTypes";
  static String loanRequest = "/api/LoanRequest";
  static String AbsenceRequest = "/api/AbsenceRequest";
  static String attendenceRequest = "/api/AttendanceAndDeparture";
