...
class ReusableSelectTradeRegistryType extends StatefulWidget {
  ReusableSelectTradeRegistryType({
    super.key,
  ...
  @override
  State<ReusableSelectTradeRegistryType> createState() =>
      _ReusableSelectTradeRegistryTypeState();
}

class _ReusableSelectTradeRegistryTypeState
    extends State<ReusableSelectTradeRegistryType> {
  @override
