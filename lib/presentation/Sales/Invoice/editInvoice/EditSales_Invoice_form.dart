...
class EditSalesInvoiceForm extends StatefulWidget {
  const EditSalesInvoiceForm({super.key});

  @override
  State<EditSalesInvoiceForm> createState() => _EditSalesInvoiceFormState();
}

class _EditSalesInvoiceFormState extends State<EditSalesInvoiceForm> {
 ...
 */
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) =>
          salesInvoiceCubit..fetchSalesInvoiceDataByID(id: invoiceId),
      child: Form(
              ...
              Row(
                ...
                children: [
                  buildSaveButton(
                    ...
                    context: context,
                    onPressed: () async {
                      salesInvoiceCubit.updateSalesReport(
