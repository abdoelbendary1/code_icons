...
class SelectItemEntityCode extends StatelessWidget {
  SelectItemEntityCode(
      {super.key,
        ...
        children: [
          ...
          CustomDropdown.search(
            headerBuilder: (context, selectedItem, enabled) {
              selectedItem as SalesItemDm;
              return Text(
                selectedItem.itemCode1.toString(),
