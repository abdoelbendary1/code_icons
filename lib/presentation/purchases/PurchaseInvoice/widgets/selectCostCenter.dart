...
class SelectCostCenterEntity extends StatelessWidget {
  SelectCostCenterEntity(
      {super.key,
        ...
        children: [
          ...
          CustomDropdown.search(
            headerBuilder: (context, selectedItem, enabled) {
              selectedItem as CostCenterEntity;
              return Text(
                selectedItem.costcenterNameAr!,
