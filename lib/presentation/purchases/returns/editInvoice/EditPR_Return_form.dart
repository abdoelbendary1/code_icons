...
class EditPrReturnForm extends StatefulWidget {
  const EditPrReturnForm({super.key});

  @override
  State<EditPrReturnForm> createState() => _EditPrReturnFormState();
}

class _EditPrReturnFormState extends State<EditPrReturnForm> {
 ...
 */
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => purchasesCubit..fetchPrReturnDataByID(id: invoiceId),
      child: Form(
              ...
              Row(
                ...
                children: [
                  buildSaveButton(
                    ...
                    context: context,
                    onPressed: () async {
                      purchasesCubit.updatePrReturnReport(
                ...
                builder: (context, state) {
                  return Visibility(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                            child: BlocBuilder<PurchasesCubit,
                                PurchasesState>(
                          bloc: purchasesCubit,
                          builder: (context, state) {
                            purchasesCubit.selectedDrawerEntity =
                                purchasesCubit.selectDrawer(DrawerDm(id: 1));
